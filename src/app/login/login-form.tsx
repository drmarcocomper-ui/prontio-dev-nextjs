    ...
    <>
      ...
      <form action={formAction} aria-label="Formulário de login" aria-busy={isPending} className="space-y-4">
        ...
        <button
          type="submit"
          disabled={isPending}
          className="inline-flex w-full items-center justify-center gap-2 rounded-lg bg-sky-600 px-4 py-2.5 text-sm font-semibold text-white shadow-sm transition-colors hover:bg-sky-700 disabled:opacity-50"
        >
          {isPending && (
