...
const DIAS = [
  ...
  { key: "seg", label: "Segunda-feira", dia_semana: 1 },
  { key: "ter", label: "Terça-feira", dia_semana: 2 },
  { key: "qua", label: "Quarta-feira", dia_semana: 3 },
  { key: "qui", label: "Quinta-feira", dia_semana: 4 },
  { key: "sex", label: "Sexta-feira", dia_semana: 5 },
...
const TIME_INPUT_CLASS =
  "rounded-lg border border-gray-300 px-2.5 py-1.5 text-sm shadow-sm focus:border-primary-500 focus:outline-none focus:ring-1 focus:ring-primary-500 disabled:opacity-50";
  ...
  return (
    <form key={formKey} action={formAction} className="space-y-4 sm:space-y-6" aria-busy={isPending}>
      ...
      <div className="space-y-3">
        <p className="text-sm font-medium text-gray-700">Horários por dia da semana</p>
            ...
            return (
              ...
              >
                ...
                <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
                  {/* Toggle */}
                  <label className="flex w-full sm:w-36 items-center gap-2 cursor-pointer select-none">
                    <input
                      type="checkbox"
                      checked={h.ativo}
                    ...
                    />
                    <span className={`text-sm font-medium ${h.ativo ? "text-gray-700" : "text-gray-400"}`}>
                      {dia.label}
                    </span>
                  </label>
                ...
                {h.ativo && (
                  <div className="mt-2 flex flex-wrap items-center gap-x-4 gap-y-2 pl-0 sm:pl-40">
