...
export function PrintActions({ id, defaultFormato }: { id: string; defaultFormato: string }) {
  ...
  return (
    <div className="flex items-center gap-2">
      <Link
        href={`/exames/${id}/imprimir?formato=particular`}
      ...
      <Link
        href={`/exames/${id}/imprimir?formato=sadt`}
        className={`inline-flex items-center gap-2 rounded-lg px-4 py-2.5 text-sm font-semibold shadow-sm transition-colors ${
          formato === "sadt"
            ? "bg-primary-600 text-white hover:bg-primary-700"
            : "border border-gray-300 bg-white text-gray-700 hover:bg-gray-50"
